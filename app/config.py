...
# server.config['SQLALCHEMY_DATABASE_URI'] = 'Driver={ODBC Driver 18 for SQL Server};Server=tcp:editora-aprender-homolog.database.windows.net,1433;Database=editora-aprender-homolog;Uid=ponceTechADM;Pwd={@Ponce1234};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;'
